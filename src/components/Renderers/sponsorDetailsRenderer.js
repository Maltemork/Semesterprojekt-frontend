...
const SponsorDetailsRenderer = ({ sponsorObject }) => {
    ...
    function DetailsHTML() {
        return (<div className="detail-text-container">
                    ...
                    <Link to={sponsorObject.sponsoring && `../children/` + sponsorObject.sponsoring }>
                    ...
                    <p name="active" style={sponsorObject.active ? {
                                'color': "green",
                                "fontWeight": "bold"
                            } : {
                                'color': "red",
                                "fontWeight": "bold"
                            }}>{sponsorObject.active ? "Active" : "Inactive"}</p>
    ...
    return (
        <div className="detail-view">
            ...
            <div className="detail-card">
                ...
                {/* DIALOG SECTION */}
                <DeleteDialog   open={open} handleClose={handleClose} handleDelete={handleDelete} object={sponsorObject} />
            </div>
