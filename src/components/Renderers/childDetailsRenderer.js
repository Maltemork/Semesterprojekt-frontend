  ...
  function DetailHTML({ childObject }) {
    return (
      <div className="detail-text-container">
        ...
        <Link
          to={
            childObject.previousSponsor &&
            `../sponsors/` + childObject.previousSponsor
          }
          name="sponsor1"
        >
        ...
        <p>
          {childObject && childObject.getAge
            ? childObject.getAge()
            : "Unable to compute"}
        </p>
        ...
        <p name="schoolstart">
          {new Date(childObject.schoolStart).toLocaleDateString("en-DE")}
        </p>
        ...
        <p name="notes" className="detail-notes">
          {" "}
          {childObject.notes ? childObject.notes : "No notes yet."}
        </p>
      </div>
    );
  }
