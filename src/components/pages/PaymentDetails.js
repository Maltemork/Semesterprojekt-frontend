    ...
    return (
        <div className="detail-view-sponsor">
            ...
            <div className="sponsor-card">
                ...
                <h2>Reepay handle (donations): { sponsorObject.reepayHandleDonations ? sponsorObject.reepayHandleDonations : "None"}</h2>
                <h2>Reepay handle (periamma): { sponsorObject.reepayHandlePeriamma ? sponsorObject.reepayHandlePeriamma : "None"}</h2>
